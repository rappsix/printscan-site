        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {servicesCatalog.map((service) => (
            <Link
              ...
              className="group relative flex h-full flex-col gap-5 overflow-hidden rounded-2xl border border-border bg-surface-raised/60 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-brand/60 hover:bg-surface-raised"
            >
